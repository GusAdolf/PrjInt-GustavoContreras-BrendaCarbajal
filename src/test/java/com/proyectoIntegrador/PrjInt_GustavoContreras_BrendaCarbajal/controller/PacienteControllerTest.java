...
class PacienteControllerTest {
    ...
    void setUp() {
        ...
        paciente1 = new Paciente(1L, "Juan", "Pérez", "12345678", LocalDate.now(), null, null);
        paciente2 = new Paciente(2L, "Ana", "López", "87654321", LocalDate.now(), null, null);
    }
    ...
    void testActualizarPaciente() {
        ...
        Paciente pacienteActualizado = new Paciente(1L, "Carlos", "Rodríguez", "12345678", LocalDate.now(), null, null);
        ResponseEntity<Paciente> response = pacienteController.actualizar(1L, pacienteActualizado);
